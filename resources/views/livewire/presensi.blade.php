            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div>
                    ...
                    <div class="bg-gray-200 p-4 rounded-lg">
                        ...
                        @else
                            <p class="text-black"><strong>Status : </strong>WFO</p>
                        @endif
                    </div>
                ...
                <div>
                    ...
                    <form method="POST" class="flex justify-between" wire:submit='store' enctype="multipart/form-data">
                        <button type="button" onclick="tagLocation()"
                            class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition duration-300">Tag
                            Location</button>
                        @if ($insideRadius)
            ...
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                if (isWithinRadius(lat, lng, office, radius)) {
                    ...
                    if (is_wfa) {
                        ...
                        alert('Anda tidak berada dalam radius kantor')
                    }
                }
            });
        } else {
